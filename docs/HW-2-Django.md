# HW 2. Python Django  (Due Friday week 4, Jan 30, 2026)
...
(venv) $ django-admin startproject uncommondata uncommondata
```
...
## Grading (8 points)
1. (1 point) Does project2-username/tables.txt exist and does it contain the expected django tables?
